...
describe('EmergencyCard Component', () => {
	...
	it('renders user information correctly', () => {
		render(<EmergencyCard userName="John Doe" emergencyTime='2024-03-24T12:00:00' emergencyId="123" emergency={mockEmergency} />);

		expect(screen.getByText('John Doe')).toBeInTheDocument();
		expect(screen.getByText('2024-03-24T12:00:00')).toBeInTheDocument();
	});
	...
	it('renders emergency information', () => {
		render(<EmergencyCard emergency={mockEmergency} userName="John Doe" emergencyTime='2024-03-24T12:00:00' emergencyId="123" />);
